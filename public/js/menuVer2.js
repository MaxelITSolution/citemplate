// JavaScript Document
   $(document).ready(function(e) {
	  ...
	  function cekWarna(paramNama,paramElement)
	  {
		  if(name == "menu_forsale" || name=="menu_forlease" )
			   {
				   //jangan merubah warna label menu
				  paramElement.css({"color":"#29AAE2"});  
			   }
			   else if( paramElement.hasClass("menuSelected")==true )
			   {
			       paramElement.css({"color":"#29AAE2"});  
			   }
			   else
			   {  
				   paramElement.css({"color":"#033066"});  
				   paramElement.children("span").css({"visibility":"hidden"});
			   }
	  }
